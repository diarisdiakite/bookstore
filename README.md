...
The [Bookstore project]() is a Library App that allows users to store books. Users can display a list of books, add a book or remove a selected book. The project uses educers and actions, Redux in React components and makes an API call to an external API.
...
```[Tech-stack]
client: React, Redux, HTML, CSS and Javascript.
````
...
`Bookstore` key features are the following main projects:
...
```sh
git clone https://github.com/diarisdiakite/bookstore/
...
To run the Bookstore application, execute the following command: Open the project in code editor and run the project using npm start.
...
You can deploy the Bookstore application using: google cloud, Microsoft Azure, Netlify by giving credit on usign our template or contricute via pull requests (read more in the contributing section).
...
If you like the [Bookstore]() you can support our work. Visit othe links [Didy personal page](https://diarisdiakite.github.io/my-portfolio/).
